...
public final class JTSUtils {
     ...
     */
    public static final org.locationtech.jts.geom.GeometryFactory
    	GEOMETRY_FACTORY = new org.locationtech.jts.geom.GeometryFactory();
    ...
    public static Geometry jtsToGo1(
        ...
        if (geomType.equalsIgnoreCase("Point")) {
            ...
            Ring result = linearRingToRing(
                    (org.locationtech.jts.geom.LinearRing) jtsGeom, crs);
            return result;
     ...
     */
    public static org.locationtech.jts.geom.Coordinate
    ...
    public static void directPositionToCoordinate(DirectPosition dp,
            org.locationtech.jts.geom.Coordinate result) {
        int d = dp.getDimension();
        if (d >= 1) {
     ...
     */
    public static org.locationtech.jts.geom.Point
     ...
     */
    public static DirectPosition pointToDirectPosition(org.locationtech.jts.geom.Point p,
            CoordinateReferenceSystem crs) {
        return coordinateToDirectPosition(p.getCoordinate(), crs);
    }

    public static Ring linearRingToRing(org.locationtech.jts.geom.LineString jtsLinearRing,
            CoordinateReferenceSystem crs) {
     ...
     */
    public static double distance(org.locationtech.jts.geom.Geometry g1,
