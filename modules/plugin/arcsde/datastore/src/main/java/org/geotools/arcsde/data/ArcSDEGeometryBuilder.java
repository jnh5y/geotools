...
public abstract class ArcSDEGeometryBuilder {
     ...
     *             if the <code>org.locationtech.jts.geom.GeometryFactory</code> this builder is
     *             backed by can't create the <code>org.locationtech.jts.geom.Geometry</code> with
     *             the <code>org.locationtech.jts.geom.Coordinate[]</code> provided by
     ...
     *             class (like <code>org.locationtech.jts.geom.MultiPoint.class</code> i.e.)
     */
